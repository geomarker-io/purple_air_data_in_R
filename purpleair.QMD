...
::: callout-important
It is highly recommended that you are somewhat familiar with using R and RStudio before continuing on with this vignette. If you want to learn more about the basics of R and RStudio, [another vignette is available on GitHub](https://github.com/colegasn/Rintro) that walks through everything you need to know before you begin. Topics that are assumed here (and covered in the [R tutorial vignette](https://colegasn.github.io/Rintro/)) include the following:

-   Install R and RStudio onto your computer.

-   Become familiar with the RStudio environment.

-   Opening and using R scripts.

-   Saving and loading data files.

-   Sourcing another R script.
